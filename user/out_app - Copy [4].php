...
?>
<!doctype html>
<html><!-- InstanceBegin template="/Templates/outpass.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
<meta charset="utf-8">
...
<div id="container"> 
  ...
  <div id='section-box'> 
    ...
    <div class='subsection animate'><!-- InstanceBeginEditable name="subsection" -->
    <div class='subsection animate'></div>
    	<?php
		if(isset($_GET['c'])){
			$cmd = $_GET['c'];
			if($cmd=='aotpLap'){
				...
				include('../include/sotpLap.php');
			}elseif($cmd=='cotpLap'){
				include('../include/sotpLap.php');
			}else{
				header("location: index.php?c=app");
				exit();
			}
		}else{
				header("location: index.php?c=app");
